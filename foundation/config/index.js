...
if (fs.existsSync(path.resolve(relative, './config/base.js'))) {
  // eslint-disable-next-line global-require, import/no-dynamic-require
  config = merge(config, require(`${ relative }/config/base`));
}

if (process.env.NODE_ENV && fs.existsSync(path.resolve(relative, `./config/${ process.env.NODE_ENV.toLowerCase() }.js`))) {
  // eslint-disable-next-line global-require, import/no-dynamic-require
